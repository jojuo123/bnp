...
def run_train(args, hparams):
    ...
    word_vocab = ["UNK", "<START>", "<END>"] + sorted(word_vocab)
    word_vocab = {label: i for i, label in enumerate(word_vocab)}

    with open('test.txt', 'a') as f: 
        print(word_vocab, file=f)
        print(tag_vocab, file=f)
        print(label_vocab, file=f)
